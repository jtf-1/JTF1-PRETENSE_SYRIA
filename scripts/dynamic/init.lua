...
local savefile = 'pretense_syria_1.0.json'
if lfs then 
...
pl:registerSquadGroup(PlayerLogistics.infantryTypes.capture,  'capture-squad',  700, 1, 60,    60*30, 4)
pl:registerSquadGroup(PlayerLogistics.infantryTypes.sabotage, 'sabotage-squad', 800, 1, 60*5,  60*30, 4)
pl:registerSquadGroup(PlayerLogistics.infantryTypes.ambush,   'ambush-squad',   900, 1, 60*20, 60*30, 4)
pl:registerSquadGroup(PlayerLogistics.infantryTypes.engineer, 'engineer-squad', 200, 1,60,    60*30, 2)
pl:registerSquadGroup(PlayerLogistics.infantryTypes.manpads,  'manpads-squad',  900, 1, 60*20, 60*30, 4)
pl:registerSquadGroup(PlayerLogistics.infantryTypes.spy,      'spy-squad',      100, 1, 60*10, 60*30, 1)
pl:registerSquadGroup(PlayerLogistics.infantryTypes.rapier,   'rapier-squad',   1200,1,60*60, 60*30, 4)
...
ensureSpawn = {
	['etturra-suport-blue'] = zones.etturra, -- done
	['jasim-suport-blue'] = zones.jasim, -- done
	['hotel-suport-blue'] = zones.hotel, -- done
	['hawash-suport-blue'] = zones.hawash, -- done
	['busra-suport-blue'] = zones.busra, -- done
	['madaya-suport-blue-1'] = zones.madaya, -- done
